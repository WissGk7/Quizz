def welcome_to_this_quizz():
    print("Bonjour et bienvenue dans ce Quizz sur la culture général de la France!")
    print("Commençons !")
...
for q in qcm:
    print("-" * 40)  # Avant chaque question
    print("\n" + q["question"])
    ...
    print("-" * 40)  # Après chaque réponse

print("-" * 40)
print(f"Quiz terminé ! Votre score est {score} sur {len(qcm)}.")
print(f"Vous avez obtenu {score * 20 // len(qcm)} points sur 20.")
print("-" * 40)